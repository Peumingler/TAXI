...
exports.send_register_mail = function(toAddress, userId, nick, callback) {
    email_query.create_email_verify(userId, (err, encryptedStr) => {
        if(encryptedStr) {
            //이메일 html 생성
            ejs.renderFile('views/mail/register_mail.ejs', {nickname: nick, verifyStr: encryptedStr}, {}, (err, str) => {
...
exports.send_find_password_mail = function(toAddress, userId, callback) {
    email_query.create_email_verify(userId, (err, encryptedStr) => {
        if(encryptedStr) {
            ejs.renderFile('views/mail/find_password_mail.ejs', {verifyStr: encryptedStr}, {}, (err, str) => {
